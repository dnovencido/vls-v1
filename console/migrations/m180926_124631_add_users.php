...
class m180926_124631_add_users extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert('{{%employee}}',['id'=>'2','fname'=>'Pedro','lname'=>'Kalza','address'=>'New Zealand','office'=>'2','position'=>'2','mobile_no'=>'+6421123124']);
        $this->insert('{{%employee}}',['id'=>'3','fname'=>'Analiza','lname'=>'Bartolome','address'=>'Naguilian La Union','office'=>'2','position'=>'2','mobile_no'=>'+6421134123']);
        $this->execute('SET foreign_key_checks = 1;');
    }
